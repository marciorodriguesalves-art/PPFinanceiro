...
async def import_statement(
    ...
    """Importa fatura de cartão ou extrato de conta (CSV) para a competência informada."""
    ...
    for p in parsed:
        ...
        if is_installment:
            # Deriva a competência da 1ª parcela a partir da parcela atual.
            offset = (p.installment_current or 1) - 1
            start_month0 = (month - 1) - offset
            start_year = year + (start_month0 // 12)
